...
mod tests {
    ...
    fn test_assistant_name_default() {
        ...
        assert_eq!(settings.assistant_name(), "Spot");
    }
    ...
    fn test_agent_pin_key_format() {
        assert_eq!(Settings::agent_pin_key("spot"), "agent_pin.spot");
    ...
    fn test_get_agent_pinned_model_none() {
        ...
        assert!(settings.get_agent_pinned_model("spot").is_none());
    }
    ...
    fn test_set_and_get_agent_pinned_model() {
        ...
        settings.set_agent_pinned_model("spot", "gpt-4o").unwrap();
        assert_eq!(
            settings.get_agent_pinned_model("spot"),
    ...
    fn test_get_all_agent_pinned_models() {
        ...
        assert_eq!(pins.get("spot"), Some(&"gpt-4o".to_string()));
    ...
    fn test_clear_pins_for_model_no_match() {
        ...
        settings
            .set_agent_pinned_model("spot", "claude-3-opus")
            .unwrap();
        settings
    ...
    fn test_agent_mcp_key_format() {
        assert_eq!(Settings::agent_mcp_key("spot"), "agent_mcp.spot");
    ...
    fn test_get_agent_mcps_empty() {
        ...
        let mcps = settings.get_agent_mcps("spot");
    ...
    fn test_set_and_get_agent_mcps() {
        ...
        settings.set_agent_mcps("spot", &mcps).unwrap();

        let result = settings.get_agent_mcps("spot");
    ...
    fn test_add_agent_mcp() {
        ...
        settings.add_agent_mcp("spot", "github").unwrap();
        settings.add_agent_mcp("spot", "slack").unwrap();
    ...
    fn test_remove_agent_mcp() {
        ...
        settings.add_agent_mcp("spot", "github").unwrap();
        settings.add_agent_mcp("spot", "slack").unwrap();
        settings.add_agent_mcp("spot", "jira").unwrap();

        settings.remove_agent_mcp("spot", "slack").unwrap();
    ...
    fn test_remove_agent_mcp_nonexistent() {
        ...
        settings.remove_agent_mcp("spot", "nonexistent").unwrap();
    ...
    fn test_clear_agent_mcps() {
        ...
        settings.clear_agent_mcps("spot").unwrap();
    ...
    fn test_get_all_agent_mcps() {
        ...
        let spot_mcps = all_mcps.get("spot").unwrap();
        assert_eq!(spot_mcps.len(), 2);
        assert!(spot_mcps.contains(&"github".to_string()));
        assert!(spot_mcps.contains(&"slack".to_string()));
    ...
    fn test_agent_mcps_handles_whitespace() {
        ...
        settings
            .set("agent_mcp.spot", "github , slack , jira")
            .unwrap();
    ...
    fn test_agent_mcps_filters_empty_entries() {
        ...
        settings.set("agent_mcp.spot", "github,,slack,").unwrap();
    ...
    fn test_overwrite_agent_pinned_model() {
        ...
        settings.set_agent_pinned_model("spot", "gpt-4").unwrap();
        settings.set_agent_pinned_model("spot", "gpt-4o").unwrap();
        ...
        // Should only have one entry for spot
    ...
    fn test_set_agent_mcps_empty_clears() {
        ...
        settings.add_agent_mcp("spot", "mcp1").unwrap();
        settings.add_agent_mcp("spot", "mcp2").unwrap();

        // Setting empty list should effectively clear
        settings.set_agent_mcps("spot", &[]).unwrap();
