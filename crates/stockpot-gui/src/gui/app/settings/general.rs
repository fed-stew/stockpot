                            ...
                            div()
                                ...
                                .child(
                                    div()
                                        .text_size(px(12.))
                                        .text_color(theme.text_muted)
                                        .child(format!("Target Tokens: {}", stockpot_core::tokens::format_tokens_with_separator(current_target))),
                                )
                                .child(
                                    div()
                                        .flex()
                                        ...
                                        .children([10_000, 20_000, 30_000, 50_000, 75_000].iter().map(|tokens| {
                                            ...
                                            div()
                                                ...
                                                .child(stockpot_core::tokens::format_tokens_with_separator(*tokens))
                                        })),
                                )
                                .child(
                                    div()
